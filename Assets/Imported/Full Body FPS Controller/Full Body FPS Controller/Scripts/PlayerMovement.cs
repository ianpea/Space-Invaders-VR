...
namespace EasySurvivalScripts
{
    ...
    public class PlayerMovement : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            characterController.detectCollisions = false; //no hit by bullets
        ...
        void HandlePlayerControls()
        {
            ...
            Vector3 fwdMovement = characterController.isGrounded == true ?  playerCam.transform.forward * vInput : Vector3.zero;
            Vector3 rightMovement = characterController.isGrounded == true ? playerCam.transform.right * hInput : Vector3.zero;
